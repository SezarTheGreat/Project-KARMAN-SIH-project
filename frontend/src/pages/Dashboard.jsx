  ...
  return (
    <div className="min-h-screen pb-12">
      ...
      <main className="px-6 mt-6">
        ...
        {/* Controls Bar */}
        <div className="flex flex-wrap items-center justify-between gap-4 bg-[#0b0f19] border border-[#1f293d] p-4 rounded-xl mb-6">
          <div>
            <h2 className="font-mono font-bold text-sm text-slate-100 flex items-center gap-2">
              DISTRICT COMMAND CENTER • LIVE WHATSAPP INTAKE STREAM
            </h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="bg-[#030712] border border-slate-700 text-xs text-slate-100 rounded-lg pl-9 pr-3 py-2 w-56 focus:outline-none focus:border-[#00e5ff]"
              />
            </div>
            ...
            <select 
              ...
              className="bg-[#030712] border border-slate-700 text-xs text-slate-200 rounded-lg px-3 py-2 focus:outline-none focus:border-[#00e5ff] font-mono"
            >
            ...
            <button 
              ...
              className="p-2 bg-[#111827] hover:bg-slate-800 border border-slate-700 text-slate-300 rounded-lg transition"
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-[#0b0f19] border border-[#1f293d] rounded-xl font-mono text-xs text-slate-400">
